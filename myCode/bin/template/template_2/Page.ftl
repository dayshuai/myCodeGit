...
<html>
	...
	<script>
		var columnsZh="<#list columnList as column><#if column.isShow=="YES">${column.columnZhName}<#if column_has_next>,</#if></#if></#list><#if isRelation=="true">,</#if><#list relationList as relation><#if relation.relation!='ManyToMany'&&relation.relation!='OneToMany'>${relation.relationShowColumnZhName}<#if relation_has_next>,</#if></#if></#list>";
		var columnsEn="<#list columnList as column>${column.columnName?uncap_first}<#if column_has_next>,</#if></#list><#if isRelation=="true">,</#if><#list relationList as relation><#if relation.relation!='ManyToMany'&&relation.relation!='OneToMany'>${relation.relationShowColumnName}<#if relation_has_next>,</#if></#if></#list>";	//对应的对象属性
